...
const CrearCitas = () => {
  ...
  const fetchOccupiedTimes = async () => {
    try {
      const response = await axios.get(
        `https://47f025a5-3539-4402-babd-ba031526efb2-00-xwv8yewbkh7t.kirk.replit.dev/api/agendas/horasOcupadas?fecha=${dayjs(
          date
        ).format("YYYY-MM-DD")}`
      );
    ...
    if (activeStep === steps.length - 1) {
      ...
      try {
        const response = await axios.post(
          "https://47f025a5-3539-4402-babd-ba031526efb2-00-xwv8yewbkh7t.kirk.replit.dev/api/agendas/crearAgenda",
          newAppointment
        );
  ...
  const handleEmployeeChange = (event) => {
    ...
    if (empleadoSeleccionado) {
      setImagenEmpleado(
        `https://47f025a5-3539-4402-babd-ba031526efb2-00-xwv8yewbkh7t.kirk.replit.dev${empleadoSeleccionado.Img}`
  ...
  const handleServicioChange = (e) => {
    ...
    if (servicioSeleccionado) {
      ...
      setImagenServicio(
        `https://47f025a5-3539-4402-babd-ba031526efb2-00-xwv8yewbkh7t.kirk.replit.dev${servicioSeleccionado.ImgServicio}`
      ); // Asegúrate de que la URL esté bien formada
    }
  };
  const handleClienteChange = (e) => {
    ...
    if (clienteSeleccionado) {
      setImagenCliente(
        `https://47f025a5-3539-4402-babd-ba031526efb2-00-xwv8yewbkh7t.kirk.replit.dev${clienteSeleccionado.Img}`
      ); // Asegúrate de que la URL esté bien formada
    }
  };
...
<TableRow>
  <TableCell sx={{ fontWeight: "bold" }}>Hora de inicio</TableCell>
  <TableCell>
    <Box display="flex" alignItems="center">
