...
import CheckIcon from '@mui/icons-material/Check'; // Importa CheckIcon
    ...
    <>
      ...
      >
        ...
        <Box>
          ...
          >
            Johan y Eduardo son novios se besan al escondidas en el sena... ☠️☠️
          </Typography>
          <Typography
            variant="body1"
            sx={{ 
      ...
      <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
        <DialogTitle>{service.Nombre_Servicio}</DialogTitle>
        <DialogContent>
          <Typography variant="body2">
            Descripción del servicio detallada...
          </Typography>
        </DialogContent>
        <DialogActions>
