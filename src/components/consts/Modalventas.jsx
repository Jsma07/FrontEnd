...
const ModalAdiciones = ({
  ...
  const handleAdd = (id) => {
    ...
    setAdicionesAgregadas([...adicionesAgregadas, id]); // Agregar el IdAdiciones a la lista de adiciones agregadas
  };
                ...
                <Card className="w-full max-w-[14rem] shadow-lg">
                  <CardHeader floated={false} color="blue-gray">
                    <img
                      ...
                      className="h-25 object-cover w-full"
                    />
                  </CardHeader>
                  <CardBody>
                    <div className="mb-3">
                      ...
                      <Typography color="blue-gray" className="text-sm">
                        <Tooltip content={`Precio: $${adicion.Precio}`}>
